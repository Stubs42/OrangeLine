...
*/
// XO-family Output Expander with a different job than XO16/XOD16: instead of passing the browsed
...
// moduleProcess()). Always jack-bearing, full Touch, same as XO16.
#define XR_CAPACITY 16
...
//
// Input Ids - XR16 has no real CV inputs at all
//
enum InputIds {
	NUM_INPUTS
};
...
enum LightIds {
	...
	// while nothing is connected (see XRModuleCommon.hpp's own moduleProcess() comment).
	OVERFLOW_LIGHT,
